    ...
    render(){
        const cases = [
            { 
              ...
              content: 'Provides a verification service on the issuance of notarized documents of financial power of attorney for diplomatic offices based on blockchain. Through this, you can expect to simplify service processing, reduce restrictions, and prevent forgery and tampering of documents.',
            },
            {
              img: process.env.PUBLIC_URL + "/images/case/case_gas.png",
              subject: 'Carbon credit transaction history service',
              summary: 'The transaction history of carbon credits is managed through a blockchain to ensure transparency in the transaction history',
